...
import { trimRightNull } from './Util.js';
...
const Iid3v1Token = {
  ...
  /**
   * @param {Uint8Array} buf Buffer possibly holding the 128 bytes ID3v1.1 metadata header
   * @param {number} off Offset in buffer in bytes
   * @returns {Object|null} ID3v1.1 header if first 3 bytes equals 'TAG', otherwise null is returned
   */
  get: (buf, off) => {
